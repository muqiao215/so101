...
- command requestId: `req-r2c-20260314210158`
...
- launch log:
  - `docs/evidence/r2c-003-launch-20260314210158.log`
- status log:
  - `docs/evidence/r2c-003-status-20260314210158.log`
- trajectory log:
  - `docs/evidence/r2c-003-trajectory-20260314210158.log`
- publish log:
  - `docs/evidence/r2c-003-publish-20260314210158.log`
- capture log:
  - `docs/evidence/r2c-003-capture-20260314210158.log`
